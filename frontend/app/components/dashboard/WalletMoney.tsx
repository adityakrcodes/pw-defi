          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-neutral-700/30 rounded-lg">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-neutral-400">$34,891</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-neutral-700/30 rounded-lg">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-neutral-400">$10,234.56</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-neutral-700/30 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-400">Raydium</p>
                </div>
              </div>
              <div className="text-right">
                <p className="font-medium">1,567.89 RAY</p>
                <p className="text-sm text-neutral-400">$4,703.67</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-neutral-700/30">
              <tr>
                ...
                <th className="text-left p-4 text-neutral-400">Address</th>
            ...
            <tbody className="divide-y divide-neutral-700/30">
              ...
              <tr className="hover:bg-neutral-700/10">
                ...
                <td className="p-4 text-green-500">+500 USDC</td>
                <td className="p-4">
