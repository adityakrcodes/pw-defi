    ...
    >
      <div className="w-full max-w-md" x-data="{ isLogin: true }">
        <div className="bg-neutral-800 rounded-lg border border-neutral-700/30 p-8">
          ...
          <div className="flex border border-neutral-700/30 rounded-lg mb-8">
            <button className="bg-neutral-700 text-white flex-1 py-2 rounded-lg transition-all duration-300">
              Login
            </button>
            <button className="flex-1 py-2 rounded-lg transition-all duration-300 bg-neutral-700 text-white">
              Sign Up
            </button>
          </div>
          ...
          {/* <form x-show="!isLogin" className="space-y-6">
                <div>
                    ...
                    <input type="text" required className="w-full px-4 py-3 bg-neutral-700/30 border border-neutral-600 rounded-lg focus:outline-none focus:border-blue-500 text-white placeholder-neutral-500" placeholder="Enter your full name"/>
                </div>
                <div>
                    <label className="block text-sm font-medium text-neutral-300 mb-2">Email Address</label>
                    <input type="email" required className="w-full px-4 py-3 bg-neutral-700/30 border border-neutral-600 rounded-lg focus:outline-none focus:border-blue-500 text-white placeholder-neutral-500" placeholder="Enter your email"/>
                </div>
                <div>
                    <label className="block text-sm font-medium text-neutral-300 mb-2">Password</label>
                    <input type="password" required className="w-full px-4 py-3 bg-neutral-700/30 border border-neutral-600 rounded-lg focus:outline-none focus:border-blue-500 text-white placeholder-neutral-500" placeholder="Create a password"/>
                </div>
                <div>
                    <label className="block text-sm font-medium text-neutral-300 mb-2">Confirm Password</label>
                    <input type="password" required className="w-full px-4 py-3 bg-neutral-700/30 border border-neutral-600 rounded-lg focus:outline-none focus:border-blue-500 text-white placeholder-neutral-500" placeholder="Confirm your password"/>
                </div>
                <div className="flex items-start">
                    <input type="checkbox" required className="form-checkbox h-4 w-4 text-blue-500 mt-1"/>
                    <span className="ml-2 text-sm text-neutral-400">I agree to the <a href="#" className="text-blue-500 hover:text-blue-400">Terms of Service</a> and <a href="#" className="text-blue-500 hover:text-blue-400">Privacy Policy</a></span>
                </div>
                <button type="submit" className="w-full py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-medium transition-colors duration-300">
                    Create Account
                </button>
            </form> */}
