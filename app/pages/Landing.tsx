				...
				<div className="container mx-auto px-4">
					...
					>
						...
						<p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
							Access the future of finance with our secure,
							transparent, and user-friendly DeFi platform. Earn,
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
							<div>
								...
								<p className="text-muted-foreground mb-6">
									BKR DeFi was built on the principle that
									financial services should be open,
									transparent, and accessible to everyone. Our
									platform eliminates intermediaries, reduces
									costs, and provides opportunities previously
									unavailable to most investors.
								</p>
								<p className="text-muted-foreground mb-6">
									With a focus on security, usability, and
									innovation, we're creating a new standard
									for DeFi platforms that anyone can use -
				...
				<div className="container mx-auto px-4">
					<ScrollAnimation>
						<div className="max-w-3xl mx-auto text-center mb-16">
							...
							<h2 className="text-3xl md:text-4xl font-bold mb-6">
								Everything You Need to Succeed in DeFi
							</h2>
							<p className="text-muted-foreground">
								Our platform combines powerful features with an
								intuitive interface, making decentralized
				...
				<div className="container mx-auto px-4">
					<ScrollAnimation>
						<div className="max-w-3xl mx-auto text-center mb-16">
							...
							<h2 className="text-3xl md:text-4xl font-bold mb-6">
								Simple Steps to Start Your DeFi Journey
							</h2>
							<p className="text-muted-foreground">
								Getting started with BKR DeFi is easy, even if
								you're new to decentralized finance. Follow
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-2">
						...
						<ScrollAnimation delay={0.2}>
							<div className="bg-black p-8 rounded-xl shadow-sm relative">
								...
								<p className="text-muted-foreground">
									Transfer your crypto assets to the platform.
									Start small and increase as you get
						...
						<ScrollAnimation delay={0.3}>
							<div className="bg-black p-8 rounded-xl shadow-sm relative">
								...
								<p className="text-muted-foreground">
									Choose your preferred investment strategy
									from our range of options and start earning
				...
				<div className="container mx-auto px-4">
					<ScrollAnimation>
						<div className="max-w-3xl mx-auto text-center mb-16">
							...
							<h2 className="text-3xl md:text-4xl font-bold mb-6">
								Meet the Experts Behind BKR DeFi
							</h2>
							<p className="text-muted-foreground">
								Our team combines decades of experience in
								blockchain technology, finance, and user
								experience design to create the most accessible
								DeFi platform.
							</p>
						</div>
					</ScrollAnimation>
					...
					<ScrollAnimation>
						<div className="max-w-3xl mx-auto text-center">
							...
							<p className="text-white/80 mb-8 text-lg">
								Join thousands of investors already using BKR
								DeFi to grow their digital assets and access the
								future of finance.
							</p>
				...
				<div className="container mx-auto px-4 text-center">
					<div className="flex justify-center items-center">
						<div className="space-y-4">
							...
							<p className="text-muted-foreground text-sm">
								The future of decentralized finance, accessible
								to everyone. Secure, transparent, and
								innovative.
							</p>
						</div>
					</div>
					<div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
						<p className="text-sm text-muted-foreground">
							© {new Date().getFullYear()} BKR DeFi. All rights
							reserved.
						</p>
					</div>
				</div>
	...
	return (
		<div className="bg-black md:max-w-80 p-8 rounded-xl shadow-sm border border-border/40 hover:border-gray-400/20 hover:shadow-md transition-all">
			<div className="flex flex-col items-center">
				...
				<p className="text-primary font-medium text-sm mb-3 text-center">
					{role}
				</p>
